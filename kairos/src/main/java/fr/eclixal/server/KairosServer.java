...
/*
 * This file KairosServer is part of a project Kairos.kairos.
 ...
 */
public class KairosServer extends Kairos {
     ...
     */
    public KairosServer(OptionSet options) throws IOException {
        super(options);
    }
